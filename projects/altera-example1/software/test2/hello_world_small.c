...
int main() {
	...
	int i;
	for(;;){
		write_data(CMD_SET_P, 0x5555);
	}
	//memset(ram, 0, 100);
	//å�‘ ram ä¸­å†™æ•°æ�®ï¼Œå½“ ram å†™å®Œä»¥å�Žï¼Œram çš„åœ°å�€å·²ç»�å�˜ä¸º(SDRAM_BASE+0x10000+200)
//	for (i = 0; i < 100; i++) {
//		*(ram++) = i;
//	}
//	//é€†å�‘è¯»å�– ram ä¸­çš„æ•°æ�®
//	for (i = 0; i < 100; i++) {
//		printf("0x%02x \n", *(--ram));
//	}
	 ...
	 *
	 ...
	 2 #include "system.h" //ç³»ç»Ÿå¤´æ–‡ä»¶
	 3 #include "alt_types.h" //æ•°æ�®ç±»åž‹å¤´æ–‡ä»¶
	 4 #include "string.h"
	 5
	 6 //SDRAM åœ°å�€
	 ...
	 17 int i;
	 18 memset(ram,0,100);
	 19 //å�‘ ram ä¸­å†™æ•°æ�®ï¼Œå½“ ram å†™å®Œä»¥å�Žï¼Œram çš„åœ°å�€å·²ç»�å�˜ä¸º(SDRAM_BASE+0x10000+200)
	 20 for(i=0;i<100;i++){
	 21 *(ram++) = i;
	 22 }
	 23 //é€†å�‘è¯»å�– ram ä¸­çš„æ•°æ�®
	 24 for(i=0;i<100;i++){
	 25 printf("%d ",*(--ram));
	 26 }
	 27 return 0;
