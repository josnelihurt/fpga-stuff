...
module nios_core_mm_interconnect_0 (
		...
		input  wire        intel_generic_serial_flash_interface_avl_csr_translator_reset_reset_bridge_in_reset_reset, // intel_generic_serial_flash_interface_avl_csr_translator_reset_reset_bridge_in_reset.reset
		input  wire        intel_generic_serial_flash_interface_reset_reset_bridge_in_reset_reset,                    //                    intel_generic_serial_flash_interface_reset_reset_bridge_in_reset.reset
		input  wire        nios2_cpu_reset_reset_bridge_in_reset_reset,                                               //                                               nios2_cpu_reset_reset_bridge_in_reset.reset
		input  wire [20:0] nios2_cpu_data_master_address,                                                             //                                                               nios2_cpu_data_master.address
		...
		output wire [5:0]  intel_generic_serial_flash_interface_avl_csr_address,                                      //                                        intel_generic_serial_flash_interface_avl_csr.address
		output wire        intel_generic_serial_flash_interface_avl_csr_write,                                        //                                                                                    .write
		output wire        intel_generic_serial_flash_interface_avl_csr_read,                                         //                                                                                    .read
		input  wire [31:0] intel_generic_serial_flash_interface_avl_csr_readdata,                                     //                                                                                    .readdata
		output wire [31:0] intel_generic_serial_flash_interface_avl_csr_writedata,                                    //                                                                                    .writedata
		input  wire        intel_generic_serial_flash_interface_avl_csr_readdatavalid,                                //                                                                                    .readdatavalid
		input  wire        intel_generic_serial_flash_interface_avl_csr_waitrequest,                                  //                                                                                    .waitrequest
		output wire [17:0] intel_generic_serial_flash_interface_avl_mem_address,                                      //                                        intel_generic_serial_flash_interface_avl_mem.address
		output wire        intel_generic_serial_flash_interface_avl_mem_write,                                        //                                                                                    .write
		output wire        intel_generic_serial_flash_interface_avl_mem_read,                                         //                                                                                    .read
		input  wire [31:0] intel_generic_serial_flash_interface_avl_mem_readdata,                                     //                                                                                    .readdata
		output wire [31:0] intel_generic_serial_flash_interface_avl_mem_writedata,                                    //                                                                                    .writedata
		output wire [6:0]  intel_generic_serial_flash_interface_avl_mem_burstcount,                                   //                                                                                    .burstcount
		output wire [3:0]  intel_generic_serial_flash_interface_avl_mem_byteenable,                                   //                                                                                    .byteenable
		input  wire        intel_generic_serial_flash_interface_avl_mem_readdatavalid,                                //                                                                                    .readdatavalid
		input  wire        intel_generic_serial_flash_interface_avl_mem_waitrequest,                                  //                                                                                    .waitrequest
	...
	wire   [20:0] nios2_cpu_data_master_translator_avalon_universal_master_0_address;              // nios2_cpu_data_master_translator:uav_address -> nios2_cpu_data_master_agent:av_address
	...
	wire  [108:0] rsp_mux_src_data;                                                                // rsp_mux:src_data -> nios2_cpu_data_master_agent:rp_data
	...
	wire   [20:0] nios2_cpu_instruction_master_translator_avalon_universal_master_0_address;       // nios2_cpu_instruction_master_translator:uav_address -> nios2_cpu_instruction_master_agent:av_address
	...
	wire  [108:0] rsp_mux_001_src_data;                                                            // rsp_mux_001:src_data -> nios2_cpu_instruction_master_agent:rp_data
	...
	wire   [31:0] intel_generic_serial_flash_interface_avl_csr_agent_m0_readdata;                  // intel_generic_serial_flash_interface_avl_csr_translator:uav_readdata -> intel_generic_serial_flash_interface_avl_csr_agent:m0_readdata
	wire          intel_generic_serial_flash_interface_avl_csr_agent_m0_waitrequest;               // intel_generic_serial_flash_interface_avl_csr_translator:uav_waitrequest -> intel_generic_serial_flash_interface_avl_csr_agent:m0_waitrequest
	wire          intel_generic_serial_flash_interface_avl_csr_agent_m0_debugaccess;               // intel_generic_serial_flash_interface_avl_csr_agent:m0_debugaccess -> intel_generic_serial_flash_interface_avl_csr_translator:uav_debugaccess
	wire   [20:0] intel_generic_serial_flash_interface_avl_csr_agent_m0_address;                   // intel_generic_serial_flash_interface_avl_csr_agent:m0_address -> intel_generic_serial_flash_interface_avl_csr_translator:uav_address
	wire    [3:0] intel_generic_serial_flash_interface_avl_csr_agent_m0_byteenable;                // intel_generic_serial_flash_interface_avl_csr_agent:m0_byteenable -> intel_generic_serial_flash_interface_avl_csr_translator:uav_byteenable
	wire          intel_generic_serial_flash_interface_avl_csr_agent_m0_read;                      // intel_generic_serial_flash_interface_avl_csr_agent:m0_read -> intel_generic_serial_flash_interface_avl_csr_translator:uav_read
	wire          intel_generic_serial_flash_interface_avl_csr_agent_m0_readdatavalid;             // intel_generic_serial_flash_interface_avl_csr_translator:uav_readdatavalid -> intel_generic_serial_flash_interface_avl_csr_agent:m0_readdatavalid
	wire          intel_generic_serial_flash_interface_avl_csr_agent_m0_lock;                      // intel_generic_serial_flash_interface_avl_csr_agent:m0_lock -> intel_generic_serial_flash_interface_avl_csr_translator:uav_lock
	wire   [31:0] intel_generic_serial_flash_interface_avl_csr_agent_m0_writedata;                 // intel_generic_serial_flash_interface_avl_csr_agent:m0_writedata -> intel_generic_serial_flash_interface_avl_csr_translator:uav_writedata
	wire          intel_generic_serial_flash_interface_avl_csr_agent_m0_write;                     // intel_generic_serial_flash_interface_avl_csr_agent:m0_write -> intel_generic_serial_flash_interface_avl_csr_translator:uav_write
	wire    [2:0] intel_generic_serial_flash_interface_avl_csr_agent_m0_burstcount;                // intel_generic_serial_flash_interface_avl_csr_agent:m0_burstcount -> intel_generic_serial_flash_interface_avl_csr_translator:uav_burstcount
	wire          intel_generic_serial_flash_interface_avl_csr_agent_rf_source_valid;              // intel_generic_serial_flash_interface_avl_csr_agent:rf_source_valid -> intel_generic_serial_flash_interface_avl_csr_agent_rsp_fifo:in_valid
	wire  [109:0] intel_generic_serial_flash_interface_avl_csr_agent_rf_source_data;               // intel_generic_serial_flash_interface_avl_csr_agent:rf_source_data -> intel_generic_serial_flash_interface_avl_csr_agent_rsp_fifo:in_data
	wire          intel_generic_serial_flash_interface_avl_csr_agent_rf_source_ready;              // intel_generic_serial_flash_interface_avl_csr_agent_rsp_fifo:in_ready -> intel_generic_serial_flash_interface_avl_csr_agent:rf_source_ready
	wire          intel_generic_serial_flash_interface_avl_csr_agent_rf_source_startofpacket;      // intel_generic_serial_flash_interface_avl_csr_agent:rf_source_startofpacket -> intel_generic_serial_flash_interface_avl_csr_agent_rsp_fifo:in_startofpacket
	wire          intel_generic_serial_flash_interface_avl_csr_agent_rf_source_endofpacket;        // intel_generic_serial_flash_interface_avl_csr_agent:rf_source_endofpacket -> intel_generic_serial_flash_interface_avl_csr_agent_rsp_fifo:in_endofpacket
	wire          intel_generic_serial_flash_interface_avl_csr_agent_rsp_fifo_out_valid;           // intel_generic_serial_flash_interface_avl_csr_agent_rsp_fifo:out_valid -> intel_generic_serial_flash_interface_avl_csr_agent:rf_sink_valid
	wire  [109:0] intel_generic_serial_flash_interface_avl_csr_agent_rsp_fifo_out_data;            // intel_generic_serial_flash_interface_avl_csr_agent_rsp_fifo:out_data -> intel_generic_serial_flash_interface_avl_csr_agent:rf_sink_data
	wire          intel_generic_serial_flash_interface_avl_csr_agent_rsp_fifo_out_ready;           // intel_generic_serial_flash_interface_avl_csr_agent:rf_sink_ready -> intel_generic_serial_flash_interface_avl_csr_agent_rsp_fifo:out_ready
	wire          intel_generic_serial_flash_interface_avl_csr_agent_rsp_fifo_out_startofpacket;   // intel_generic_serial_flash_interface_avl_csr_agent_rsp_fifo:out_startofpacket -> intel_generic_serial_flash_interface_avl_csr_agent:rf_sink_startofpacket
	wire          intel_generic_serial_flash_interface_avl_csr_agent_rsp_fifo_out_endofpacket;     // intel_generic_serial_flash_interface_avl_csr_agent_rsp_fifo:out_endofpacket -> intel_generic_serial_flash_interface_avl_csr_agent:rf_sink_endofpacket
	wire          cmd_mux_001_src_valid;                                                           // cmd_mux_001:src_valid -> intel_generic_serial_flash_interface_avl_csr_agent:cp_valid
	wire  [108:0] cmd_mux_001_src_data;                                                            // cmd_mux_001:src_data -> intel_generic_serial_flash_interface_avl_csr_agent:cp_data
	wire          cmd_mux_001_src_ready;                                                           // intel_generic_serial_flash_interface_avl_csr_agent:cp_ready -> cmd_mux_001:src_ready
	wire    [6:0] cmd_mux_001_src_channel;                                                         // cmd_mux_001:src_channel -> intel_generic_serial_flash_interface_avl_csr_agent:cp_channel
	wire          cmd_mux_001_src_startofpacket;                                                   // cmd_mux_001:src_startofpacket -> intel_generic_serial_flash_interface_avl_csr_agent:cp_startofpacket
	wire          cmd_mux_001_src_endofpacket;                                                     // cmd_mux_001:src_endofpacket -> intel_generic_serial_flash_interface_avl_csr_agent:cp_endofpacket
	wire   [31:0] intel_generic_serial_flash_interface_avl_mem_agent_m0_readdata;                  // intel_generic_serial_flash_interface_avl_mem_translator:uav_readdata -> intel_generic_serial_flash_interface_avl_mem_agent:m0_readdata
	wire          intel_generic_serial_flash_interface_avl_mem_agent_m0_waitrequest;               // intel_generic_serial_flash_interface_avl_mem_translator:uav_waitrequest -> intel_generic_serial_flash_interface_avl_mem_agent:m0_waitrequest
	wire          intel_generic_serial_flash_interface_avl_mem_agent_m0_debugaccess;               // intel_generic_serial_flash_interface_avl_mem_agent:m0_debugaccess -> intel_generic_serial_flash_interface_avl_mem_translator:uav_debugaccess
	wire   [20:0] intel_generic_serial_flash_interface_avl_mem_agent_m0_address;                   // intel_generic_serial_flash_interface_avl_mem_agent:m0_address -> intel_generic_serial_flash_interface_avl_mem_translator:uav_address
	wire    [3:0] intel_generic_serial_flash_interface_avl_mem_agent_m0_byteenable;                // intel_generic_serial_flash_interface_avl_mem_agent:m0_byteenable -> intel_generic_serial_flash_interface_avl_mem_translator:uav_byteenable
	wire          intel_generic_serial_flash_interface_avl_mem_agent_m0_read;                      // intel_generic_serial_flash_interface_avl_mem_agent:m0_read -> intel_generic_serial_flash_interface_avl_mem_translator:uav_read
	wire          intel_generic_serial_flash_interface_avl_mem_agent_m0_readdatavalid;             // intel_generic_serial_flash_interface_avl_mem_translator:uav_readdatavalid -> intel_generic_serial_flash_interface_avl_mem_agent:m0_readdatavalid
	wire          intel_generic_serial_flash_interface_avl_mem_agent_m0_lock;                      // intel_generic_serial_flash_interface_avl_mem_agent:m0_lock -> intel_generic_serial_flash_interface_avl_mem_translator:uav_lock
	wire   [31:0] intel_generic_serial_flash_interface_avl_mem_agent_m0_writedata;                 // intel_generic_serial_flash_interface_avl_mem_agent:m0_writedata -> intel_generic_serial_flash_interface_avl_mem_translator:uav_writedata
	wire          intel_generic_serial_flash_interface_avl_mem_agent_m0_write;                     // intel_generic_serial_flash_interface_avl_mem_agent:m0_write -> intel_generic_serial_flash_interface_avl_mem_translator:uav_write
	wire    [8:0] intel_generic_serial_flash_interface_avl_mem_agent_m0_burstcount;                // intel_generic_serial_flash_interface_avl_mem_agent:m0_burstcount -> intel_generic_serial_flash_interface_avl_mem_translator:uav_burstcount
	wire          intel_generic_serial_flash_interface_avl_mem_agent_rf_source_valid;              // intel_generic_serial_flash_interface_avl_mem_agent:rf_source_valid -> intel_generic_serial_flash_interface_avl_mem_agent_rsp_fifo:in_valid
	wire  [109:0] intel_generic_serial_flash_interface_avl_mem_agent_rf_source_data;               // intel_generic_serial_flash_interface_avl_mem_agent:rf_source_data -> intel_generic_serial_flash_interface_avl_mem_agent_rsp_fifo:in_data
	wire          intel_generic_serial_flash_interface_avl_mem_agent_rf_source_ready;              // intel_generic_serial_flash_interface_avl_mem_agent_rsp_fifo:in_ready -> intel_generic_serial_flash_interface_avl_mem_agent:rf_source_ready
	wire          intel_generic_serial_flash_interface_avl_mem_agent_rf_source_startofpacket;      // intel_generic_serial_flash_interface_avl_mem_agent:rf_source_startofpacket -> intel_generic_serial_flash_interface_avl_mem_agent_rsp_fifo:in_startofpacket
	wire          intel_generic_serial_flash_interface_avl_mem_agent_rf_source_endofpacket;        // intel_generic_serial_flash_interface_avl_mem_agent:rf_source_endofpacket -> intel_generic_serial_flash_interface_avl_mem_agent_rsp_fifo:in_endofpacket
	wire          intel_generic_serial_flash_interface_avl_mem_agent_rsp_fifo_out_valid;           // intel_generic_serial_flash_interface_avl_mem_agent_rsp_fifo:out_valid -> intel_generic_serial_flash_interface_avl_mem_agent:rf_sink_valid
	wire  [109:0] intel_generic_serial_flash_interface_avl_mem_agent_rsp_fifo_out_data;            // intel_generic_serial_flash_interface_avl_mem_agent_rsp_fifo:out_data -> intel_generic_serial_flash_interface_avl_mem_agent:rf_sink_data
	wire          intel_generic_serial_flash_interface_avl_mem_agent_rsp_fifo_out_ready;           // intel_generic_serial_flash_interface_avl_mem_agent:rf_sink_ready -> intel_generic_serial_flash_interface_avl_mem_agent_rsp_fifo:out_ready
	wire          intel_generic_serial_flash_interface_avl_mem_agent_rsp_fifo_out_startofpacket;   // intel_generic_serial_flash_interface_avl_mem_agent_rsp_fifo:out_startofpacket -> intel_generic_serial_flash_interface_avl_mem_agent:rf_sink_startofpacket
	wire          intel_generic_serial_flash_interface_avl_mem_agent_rsp_fifo_out_endofpacket;     // intel_generic_serial_flash_interface_avl_mem_agent_rsp_fifo:out_endofpacket -> intel_generic_serial_flash_interface_avl_mem_agent:rf_sink_endofpacket
	wire          cmd_mux_002_src_valid;                                                           // cmd_mux_002:src_valid -> intel_generic_serial_flash_interface_avl_mem_agent:cp_valid
	wire  [108:0] cmd_mux_002_src_data;                                                            // cmd_mux_002:src_data -> intel_generic_serial_flash_interface_avl_mem_agent:cp_data
	wire          cmd_mux_002_src_ready;                                                           // intel_generic_serial_flash_interface_avl_mem_agent:cp_ready -> cmd_mux_002:src_ready
	wire    [6:0] cmd_mux_002_src_channel;                                                         // cmd_mux_002:src_channel -> intel_generic_serial_flash_interface_avl_mem_agent:cp_channel
	wire          cmd_mux_002_src_startofpacket;                                                   // cmd_mux_002:src_startofpacket -> intel_generic_serial_flash_interface_avl_mem_agent:cp_startofpacket
	wire          cmd_mux_002_src_endofpacket;                                                     // cmd_mux_002:src_endofpacket -> intel_generic_serial_flash_interface_avl_mem_agent:cp_endofpacket
	...
	wire   [20:0] nios2_cpu_debug_mem_slave_agent_m0_address;                                      // nios2_cpu_debug_mem_slave_agent:m0_address -> nios2_cpu_debug_mem_slave_translator:uav_address
	...
	wire  [109:0] nios2_cpu_debug_mem_slave_agent_rf_source_data;                                  // nios2_cpu_debug_mem_slave_agent:rf_source_data -> nios2_cpu_debug_mem_slave_agent_rsp_fifo:in_data
	...
	wire  [109:0] nios2_cpu_debug_mem_slave_agent_rsp_fifo_out_data;                               // nios2_cpu_debug_mem_slave_agent_rsp_fifo:out_data -> nios2_cpu_debug_mem_slave_agent:rf_sink_data
	...
	wire  [108:0] cmd_mux_003_src_data;                                                            // cmd_mux_003:src_data -> nios2_cpu_debug_mem_slave_agent:cp_data
	...
	wire  [108:0] cmd_mux_004_src_data;                                                            // cmd_mux_004:src_data -> onchip_memory_s1_agent:cp_data
	...
	wire   [31:0] pio_lcd_control_s1_agent_m0_readdata;                                            // pio_lcd_control_s1_translator:uav_readdata -> pio_lcd_control_s1_agent:m0_readdata
	wire          pio_lcd_control_s1_agent_m0_waitrequest;                                         // pio_lcd_control_s1_translator:uav_waitrequest -> pio_lcd_control_s1_agent:m0_waitrequest
	wire          pio_lcd_control_s1_agent_m0_debugaccess;                                         // pio_lcd_control_s1_agent:m0_debugaccess -> pio_lcd_control_s1_translator:uav_debugaccess
	wire   [20:0] pio_lcd_control_s1_agent_m0_address;                                             // pio_lcd_control_s1_agent:m0_address -> pio_lcd_control_s1_translator:uav_address
	wire    [3:0] pio_lcd_control_s1_agent_m0_byteenable;                                          // pio_lcd_control_s1_agent:m0_byteenable -> pio_lcd_control_s1_translator:uav_byteenable
	wire          pio_lcd_control_s1_agent_m0_read;                                                // pio_lcd_control_s1_agent:m0_read -> pio_lcd_control_s1_translator:uav_read
	wire          pio_lcd_control_s1_agent_m0_readdatavalid;                                       // pio_lcd_control_s1_translator:uav_readdatavalid -> pio_lcd_control_s1_agent:m0_readdatavalid
	wire          pio_lcd_control_s1_agent_m0_lock;                                                // pio_lcd_control_s1_agent:m0_lock -> pio_lcd_control_s1_translator:uav_lock
	wire   [31:0] pio_lcd_control_s1_agent_m0_writedata;                                           // pio_lcd_control_s1_agent:m0_writedata -> pio_lcd_control_s1_translator:uav_writedata
	wire          pio_lcd_control_s1_agent_m0_write;                                               // pio_lcd_control_s1_agent:m0_write -> pio_lcd_control_s1_translator:uav_write
	wire    [2:0] pio_lcd_control_s1_agent_m0_burstcount;                                          // pio_lcd_control_s1_agent:m0_burstcount -> pio_lcd_control_s1_translator:uav_burstcount
	wire          pio_lcd_control_s1_agent_rf_source_valid;                                        // pio_lcd_control_s1_agent:rf_source_valid -> pio_lcd_control_s1_agent_rsp_fifo:in_valid
	wire  [109:0] pio_lcd_control_s1_agent_rf_source_data;                                         // pio_lcd_control_s1_agent:rf_source_data -> pio_lcd_control_s1_agent_rsp_fifo:in_data
	wire          pio_lcd_control_s1_agent_rf_source_ready;                                        // pio_lcd_control_s1_agent_rsp_fifo:in_ready -> pio_lcd_control_s1_agent:rf_source_ready
	wire          pio_lcd_control_s1_agent_rf_source_startofpacket;                                // pio_lcd_control_s1_agent:rf_source_startofpacket -> pio_lcd_control_s1_agent_rsp_fifo:in_startofpacket
	wire          pio_lcd_control_s1_agent_rf_source_endofpacket;                                  // pio_lcd_control_s1_agent:rf_source_endofpacket -> pio_lcd_control_s1_agent_rsp_fifo:in_endofpacket
	wire          pio_lcd_control_s1_agent_rsp_fifo_out_valid;                                     // pio_lcd_control_s1_agent_rsp_fifo:out_valid -> pio_lcd_control_s1_agent:rf_sink_valid
	wire  [109:0] pio_lcd_control_s1_agent_rsp_fifo_out_data;                                      // pio_lcd_control_s1_agent_rsp_fifo:out_data -> pio_lcd_control_s1_agent:rf_sink_data
	wire          pio_lcd_control_s1_agent_rsp_fifo_out_ready;                                     // pio_lcd_control_s1_agent:rf_sink_ready -> pio_lcd_control_s1_agent_rsp_fifo:out_ready
	wire          pio_lcd_control_s1_agent_rsp_fifo_out_startofpacket;                             // pio_lcd_control_s1_agent_rsp_fifo:out_startofpacket -> pio_lcd_control_s1_agent:rf_sink_startofpacket
	wire          pio_lcd_control_s1_agent_rsp_fifo_out_endofpacket;                               // pio_lcd_control_s1_agent_rsp_fifo:out_endofpacket -> pio_lcd_control_s1_agent:rf_sink_endofpacket
	wire          cmd_mux_006_src_valid;                                                           // cmd_mux_006:src_valid -> pio_lcd_control_s1_agent:cp_valid
	wire  [108:0] cmd_mux_006_src_data;                                                            // cmd_mux_006:src_data -> pio_lcd_control_s1_agent:cp_data
	wire          cmd_mux_006_src_ready;                                                           // pio_lcd_control_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire    [6:0] cmd_mux_006_src_channel;                                                         // cmd_mux_006:src_channel -> pio_lcd_control_s1_agent:cp_channel
	wire          cmd_mux_006_src_startofpacket;                                                   // cmd_mux_006:src_startofpacket -> pio_lcd_control_s1_agent:cp_startofpacket
	wire          cmd_mux_006_src_endofpacket;                                                     // cmd_mux_006:src_endofpacket -> pio_lcd_control_s1_agent:cp_endofpacket
	wire          nios2_cpu_data_master_agent_cp_valid;                                            // nios2_cpu_data_master_agent:cp_valid -> router:sink_valid
	wire  [108:0] nios2_cpu_data_master_agent_cp_data;                                             // nios2_cpu_data_master_agent:cp_data -> router:sink_data
	...
	wire  [108:0] nios2_cpu_instruction_master_agent_cp_data;                                      // nios2_cpu_instruction_master_agent:cp_data -> router_001:sink_data
	...
	wire          intel_generic_serial_flash_interface_avl_csr_agent_rp_valid;                     // intel_generic_serial_flash_interface_avl_csr_agent:rp_valid -> router_003:sink_valid
	wire  [108:0] intel_generic_serial_flash_interface_avl_csr_agent_rp_data;                      // intel_generic_serial_flash_interface_avl_csr_agent:rp_data -> router_003:sink_data
	wire          intel_generic_serial_flash_interface_avl_csr_agent_rp_ready;                     // router_003:sink_ready -> intel_generic_serial_flash_interface_avl_csr_agent:rp_ready
	wire          intel_generic_serial_flash_interface_avl_csr_agent_rp_startofpacket;             // intel_generic_serial_flash_interface_avl_csr_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire          intel_generic_serial_flash_interface_avl_csr_agent_rp_endofpacket;               // intel_generic_serial_flash_interface_avl_csr_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire          intel_generic_serial_flash_interface_avl_mem_agent_rp_valid;                     // intel_generic_serial_flash_interface_avl_mem_agent:rp_valid -> router_004:sink_valid
	wire  [108:0] intel_generic_serial_flash_interface_avl_mem_agent_rp_data;                      // intel_generic_serial_flash_interface_avl_mem_agent:rp_data -> router_004:sink_data
	wire          intel_generic_serial_flash_interface_avl_mem_agent_rp_ready;                     // router_004:sink_ready -> intel_generic_serial_flash_interface_avl_mem_agent:rp_ready
	wire          intel_generic_serial_flash_interface_avl_mem_agent_rp_startofpacket;             // intel_generic_serial_flash_interface_avl_mem_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire          intel_generic_serial_flash_interface_avl_mem_agent_rp_endofpacket;               // intel_generic_serial_flash_interface_avl_mem_agent:rp_endofpacket -> router_004:sink_endofpacket
	...
	wire  [108:0] nios2_cpu_debug_mem_slave_agent_rp_data;                                         // nios2_cpu_debug_mem_slave_agent:rp_data -> router_005:sink_data
	...
	wire  [108:0] onchip_memory_s1_agent_rp_data;                                                  // onchip_memory_s1_agent:rp_data -> router_006:sink_data
	...
	wire          pio_lcd_control_s1_agent_rp_valid;                                               // pio_lcd_control_s1_agent:rp_valid -> router_008:sink_valid
	wire  [108:0] pio_lcd_control_s1_agent_rp_data;                                                // pio_lcd_control_s1_agent:rp_data -> router_008:sink_data
	wire          pio_lcd_control_s1_agent_rp_ready;                                               // router_008:sink_ready -> pio_lcd_control_s1_agent:rp_ready
	wire          pio_lcd_control_s1_agent_rp_startofpacket;                                       // pio_lcd_control_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire          pio_lcd_control_s1_agent_rp_endofpacket;                                         // pio_lcd_control_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	...
	wire          intel_generic_serial_flash_interface_avl_csr_agent_rdata_fifo_src_valid;         // intel_generic_serial_flash_interface_avl_csr_agent:rdata_fifo_src_valid -> avalon_st_adapter_001:in_0_valid
	wire   [33:0] intel_generic_serial_flash_interface_avl_csr_agent_rdata_fifo_src_data;          // intel_generic_serial_flash_interface_avl_csr_agent:rdata_fifo_src_data -> avalon_st_adapter_001:in_0_data
	wire          intel_generic_serial_flash_interface_avl_csr_agent_rdata_fifo_src_ready;         // avalon_st_adapter_001:in_0_ready -> intel_generic_serial_flash_interface_avl_csr_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_001_out_0_valid;                                               // avalon_st_adapter_001:out_0_valid -> intel_generic_serial_flash_interface_avl_csr_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_001_out_0_data;                                                // avalon_st_adapter_001:out_0_data -> intel_generic_serial_flash_interface_avl_csr_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_001_out_0_ready;                                               // intel_generic_serial_flash_interface_avl_csr_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire    [0:0] avalon_st_adapter_001_out_0_error;                                               // avalon_st_adapter_001:out_0_error -> intel_generic_serial_flash_interface_avl_csr_agent:rdata_fifo_sink_error
	wire          intel_generic_serial_flash_interface_avl_mem_agent_rdata_fifo_src_valid;         // intel_generic_serial_flash_interface_avl_mem_agent:rdata_fifo_src_valid -> avalon_st_adapter_002:in_0_valid
	wire   [33:0] intel_generic_serial_flash_interface_avl_mem_agent_rdata_fifo_src_data;          // intel_generic_serial_flash_interface_avl_mem_agent:rdata_fifo_src_data -> avalon_st_adapter_002:in_0_data
	wire          intel_generic_serial_flash_interface_avl_mem_agent_rdata_fifo_src_ready;         // avalon_st_adapter_002:in_0_ready -> intel_generic_serial_flash_interface_avl_mem_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_002_out_0_valid;                                               // avalon_st_adapter_002:out_0_valid -> intel_generic_serial_flash_interface_avl_mem_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_002_out_0_data;                                                // avalon_st_adapter_002:out_0_data -> intel_generic_serial_flash_interface_avl_mem_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_002_out_0_ready;                                               // intel_generic_serial_flash_interface_avl_mem_agent:rdata_fifo_sink_ready -> avalon_st_adapter_002:out_0_ready
	wire    [0:0] avalon_st_adapter_002_out_0_error;                                               // avalon_st_adapter_002:out_0_error -> intel_generic_serial_flash_interface_avl_mem_agent:rdata_fifo_sink_error
	...
	wire          pio_lcd_control_s1_agent_rdata_fifo_src_valid;                                   // pio_lcd_control_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire   [33:0] pio_lcd_control_s1_agent_rdata_fifo_src_data;                                    // pio_lcd_control_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire          pio_lcd_control_s1_agent_rdata_fifo_src_ready;                                   // avalon_st_adapter_006:in_0_ready -> pio_lcd_control_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_006_out_0_valid;                                               // avalon_st_adapter_006:out_0_valid -> pio_lcd_control_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_006_out_0_data;                                                // avalon_st_adapter_006:out_0_data -> pio_lcd_control_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_006_out_0_ready;                                               // pio_lcd_control_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire    [0:0] avalon_st_adapter_006_out_0_error;                                               // avalon_st_adapter_006:out_0_error -> pio_lcd_control_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) intel_generic_serial_flash_interface_avl_csr_translator (
		.clk                    (clk_main_clk_clk),                                                                          //                      clk.clk
		.reset                  (intel_generic_serial_flash_interface_avl_csr_translator_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (intel_generic_serial_flash_interface_avl_csr_agent_m0_address),                             // avalon_universal_slave_0.address
		.uav_burstcount         (intel_generic_serial_flash_interface_avl_csr_agent_m0_burstcount),                          //                         .burstcount
		.uav_read               (intel_generic_serial_flash_interface_avl_csr_agent_m0_read),                                //                         .read
		.uav_write              (intel_generic_serial_flash_interface_avl_csr_agent_m0_write),                               //                         .write
		.uav_waitrequest        (intel_generic_serial_flash_interface_avl_csr_agent_m0_waitrequest),                         //                         .waitrequest
		.uav_readdatavalid      (intel_generic_serial_flash_interface_avl_csr_agent_m0_readdatavalid),                       //                         .readdatavalid
		.uav_byteenable         (intel_generic_serial_flash_interface_avl_csr_agent_m0_byteenable),                          //                         .byteenable
		.uav_readdata           (intel_generic_serial_flash_interface_avl_csr_agent_m0_readdata),                            //                         .readdata
		.uav_writedata          (intel_generic_serial_flash_interface_avl_csr_agent_m0_writedata),                           //                         .writedata
		.uav_lock               (intel_generic_serial_flash_interface_avl_csr_agent_m0_lock),                                //                         .lock
		.uav_debugaccess        (intel_generic_serial_flash_interface_avl_csr_agent_m0_debugaccess),                         //                         .debugaccess
		.av_address             (intel_generic_serial_flash_interface_avl_csr_address),                                      //      avalon_anti_slave_0.address
		.av_write               (intel_generic_serial_flash_interface_avl_csr_write),                                        //                         .write
		.av_read                (intel_generic_serial_flash_interface_avl_csr_read),                                         //                         .read
		.av_readdata            (intel_generic_serial_flash_interface_avl_csr_readdata),                                     //                         .readdata
		.av_writedata           (intel_generic_serial_flash_interface_avl_csr_writedata),                                    //                         .writedata
		.av_readdatavalid       (intel_generic_serial_flash_interface_avl_csr_readdatavalid),                                //                         .readdatavalid
		.av_waitrequest         (intel_generic_serial_flash_interface_avl_csr_waitrequest),                                  //                         .waitrequest
		.av_begintransfer       (),                                                                                          //              (terminated)
		.av_beginbursttransfer  (),                                                                                          //              (terminated)
		.av_burstcount          (),                                                                                          //              (terminated)
		.av_byteenable          (),                                                                                          //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) intel_generic_serial_flash_interface_avl_mem_translator (
		.clk                    (clk_main_clk_clk),                                                                          //                      clk.clk
		.reset                  (intel_generic_serial_flash_interface_avl_csr_translator_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (intel_generic_serial_flash_interface_avl_mem_agent_m0_address),                             // avalon_universal_slave_0.address
		.uav_burstcount         (intel_generic_serial_flash_interface_avl_mem_agent_m0_burstcount),                          //                         .burstcount
		.uav_read               (intel_generic_serial_flash_interface_avl_mem_agent_m0_read),                                //                         .read
		.uav_write              (intel_generic_serial_flash_interface_avl_mem_agent_m0_write),                               //                         .write
		.uav_waitrequest        (intel_generic_serial_flash_interface_avl_mem_agent_m0_waitrequest),                         //                         .waitrequest
		.uav_readdatavalid      (intel_generic_serial_flash_interface_avl_mem_agent_m0_readdatavalid),                       //                         .readdatavalid
		.uav_byteenable         (intel_generic_serial_flash_interface_avl_mem_agent_m0_byteenable),                          //                         .byteenable
		.uav_readdata           (intel_generic_serial_flash_interface_avl_mem_agent_m0_readdata),                            //                         .readdata
		.uav_writedata          (intel_generic_serial_flash_interface_avl_mem_agent_m0_writedata),                           //                         .writedata
		.uav_lock               (intel_generic_serial_flash_interface_avl_mem_agent_m0_lock),                                //                         .lock
		.uav_debugaccess        (intel_generic_serial_flash_interface_avl_mem_agent_m0_debugaccess),                         //                         .debugaccess
		.av_address             (intel_generic_serial_flash_interface_avl_mem_address),                                      //      avalon_anti_slave_0.address
		.av_write               (intel_generic_serial_flash_interface_avl_mem_write),                                        //                         .write
		.av_read                (intel_generic_serial_flash_interface_avl_mem_read),                                         //                         .read
		.av_readdata            (intel_generic_serial_flash_interface_avl_mem_readdata),                                     //                         .readdata
		.av_writedata           (intel_generic_serial_flash_interface_avl_mem_writedata),                                    //                         .writedata
		.av_burstcount          (intel_generic_serial_flash_interface_avl_mem_burstcount),                                   //                         .burstcount
		.av_byteenable          (intel_generic_serial_flash_interface_avl_mem_byteenable),                                   //                         .byteenable
		.av_readdatavalid       (intel_generic_serial_flash_interface_avl_mem_readdatavalid),                                //                         .readdatavalid
		.av_waitrequest         (intel_generic_serial_flash_interface_avl_mem_waitrequest),                                  //                         .waitrequest
		.av_begintransfer       (),                                                                                          //              (terminated)
		.av_beginbursttransfer  (),                                                                                          //              (terminated)
		.av_writebyteenable     (),                                                                                          //              (terminated)
		.av_lock                (),                                                                                          //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (clk_main_clk_clk),                            //                      clk.clk
		.reset                  (nios2_cpu_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (pio_lcd_control_s1_agent_m0_address),         // avalon_universal_slave_0.address
		.uav_burstcount         (pio_lcd_control_s1_agent_m0_burstcount),      //                         .burstcount
		.uav_read               (pio_lcd_control_s1_agent_m0_read),            //                         .read
		.uav_write              (pio_lcd_control_s1_agent_m0_write),           //                         .write
		.uav_waitrequest        (pio_lcd_control_s1_agent_m0_waitrequest),     //                         .waitrequest
		.uav_readdatavalid      (pio_lcd_control_s1_agent_m0_readdatavalid),   //                         .readdatavalid
		.uav_byteenable         (pio_lcd_control_s1_agent_m0_byteenable),      //                         .byteenable
		.uav_readdata           (pio_lcd_control_s1_agent_m0_readdata),        //                         .readdata
		.uav_writedata          (pio_lcd_control_s1_agent_m0_writedata),       //                         .writedata
		.uav_lock               (pio_lcd_control_s1_agent_m0_lock),            //                         .lock
		.uav_debugaccess        (pio_lcd_control_s1_agent_m0_debugaccess),     //                         .debugaccess
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) intel_generic_serial_flash_interface_avl_csr_agent (
		.clk                     (clk_main_clk_clk),                                                                          //             clk.clk
		.reset                   (intel_generic_serial_flash_interface_avl_csr_translator_reset_reset_bridge_in_reset_reset), //       clk_reset.reset
		.m0_address              (intel_generic_serial_flash_interface_avl_csr_agent_m0_address),                             //              m0.address
		.m0_burstcount           (intel_generic_serial_flash_interface_avl_csr_agent_m0_burstcount),                          //                .burstcount
		.m0_byteenable           (intel_generic_serial_flash_interface_avl_csr_agent_m0_byteenable),                          //                .byteenable
		.m0_debugaccess          (intel_generic_serial_flash_interface_avl_csr_agent_m0_debugaccess),                         //                .debugaccess
		.m0_lock                 (intel_generic_serial_flash_interface_avl_csr_agent_m0_lock),                                //                .lock
		.m0_readdata             (intel_generic_serial_flash_interface_avl_csr_agent_m0_readdata),                            //                .readdata
		.m0_readdatavalid        (intel_generic_serial_flash_interface_avl_csr_agent_m0_readdatavalid),                       //                .readdatavalid
		.m0_read                 (intel_generic_serial_flash_interface_avl_csr_agent_m0_read),                                //                .read
		.m0_waitrequest          (intel_generic_serial_flash_interface_avl_csr_agent_m0_waitrequest),                         //                .waitrequest
		.m0_writedata            (intel_generic_serial_flash_interface_avl_csr_agent_m0_writedata),                           //                .writedata
		.m0_write                (intel_generic_serial_flash_interface_avl_csr_agent_m0_write),                               //                .write
		.rp_endofpacket          (intel_generic_serial_flash_interface_avl_csr_agent_rp_endofpacket),                         //              rp.endofpacket
		.rp_ready                (intel_generic_serial_flash_interface_avl_csr_agent_rp_ready),                               //                .ready
		.rp_valid                (intel_generic_serial_flash_interface_avl_csr_agent_rp_valid),                               //                .valid
		.rp_data                 (intel_generic_serial_flash_interface_avl_csr_agent_rp_data),                                //                .data
		.rp_startofpacket        (intel_generic_serial_flash_interface_avl_csr_agent_rp_startofpacket),                       //                .startofpacket
		...
		.rf_sink_ready           (intel_generic_serial_flash_interface_avl_csr_agent_rsp_fifo_out_ready),                     //         rf_sink.ready
		.rf_sink_valid           (intel_generic_serial_flash_interface_avl_csr_agent_rsp_fifo_out_valid),                     //                .valid
		.rf_sink_startofpacket   (intel_generic_serial_flash_interface_avl_csr_agent_rsp_fifo_out_startofpacket),             //                .startofpacket
		.rf_sink_endofpacket     (intel_generic_serial_flash_interface_avl_csr_agent_rsp_fifo_out_endofpacket),               //                .endofpacket
		.rf_sink_data            (intel_generic_serial_flash_interface_avl_csr_agent_rsp_fifo_out_data),                      //                .data
		.rf_source_ready         (intel_generic_serial_flash_interface_avl_csr_agent_rf_source_ready),                        //       rf_source.ready
		.rf_source_valid         (intel_generic_serial_flash_interface_avl_csr_agent_rf_source_valid),                        //                .valid
		.rf_source_startofpacket (intel_generic_serial_flash_interface_avl_csr_agent_rf_source_startofpacket),                //                .startofpacket
		.rf_source_endofpacket   (intel_generic_serial_flash_interface_avl_csr_agent_rf_source_endofpacket),                  //                .endofpacket
		.rf_source_data          (intel_generic_serial_flash_interface_avl_csr_agent_rf_source_data),                         //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_001_out_0_ready),                                                         // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_001_out_0_valid),                                                         //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_001_out_0_data),                                                          //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_001_out_0_error),                                                         //                .error
		.rdata_fifo_src_ready    (intel_generic_serial_flash_interface_avl_csr_agent_rdata_fifo_src_ready),                   //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (intel_generic_serial_flash_interface_avl_csr_agent_rdata_fifo_src_valid),                   //                .valid
		.rdata_fifo_src_data     (intel_generic_serial_flash_interface_avl_csr_agent_rdata_fifo_src_data),                    //                .data
		.m0_response             (2'b00),                                                                                     //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                                                       //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) intel_generic_serial_flash_interface_avl_csr_agent_rsp_fifo (
		.clk               (clk_main_clk_clk),                                                                          //       clk.clk
		.reset             (intel_generic_serial_flash_interface_avl_csr_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (intel_generic_serial_flash_interface_avl_csr_agent_rf_source_data),                         //        in.data
		.in_valid          (intel_generic_serial_flash_interface_avl_csr_agent_rf_source_valid),                        //          .valid
		.in_ready          (intel_generic_serial_flash_interface_avl_csr_agent_rf_source_ready),                        //          .ready
		.in_startofpacket  (intel_generic_serial_flash_interface_avl_csr_agent_rf_source_startofpacket),                //          .startofpacket
		.in_endofpacket    (intel_generic_serial_flash_interface_avl_csr_agent_rf_source_endofpacket),                  //          .endofpacket
		.out_data          (intel_generic_serial_flash_interface_avl_csr_agent_rsp_fifo_out_data),                      //       out.data
		.out_valid         (intel_generic_serial_flash_interface_avl_csr_agent_rsp_fifo_out_valid),                     //          .valid
		.out_ready         (intel_generic_serial_flash_interface_avl_csr_agent_rsp_fifo_out_ready),                     //          .ready
		.out_startofpacket (intel_generic_serial_flash_interface_avl_csr_agent_rsp_fifo_out_startofpacket),             //          .startofpacket
		.out_endofpacket   (intel_generic_serial_flash_interface_avl_csr_agent_rsp_fifo_out_endofpacket),               //          .endofpacket
		.csr_address       (2'b00),                                                                                     // (terminated)
		.csr_read          (1'b0),                                                                                      // (terminated)
		.csr_write         (1'b0),                                                                                      // (terminated)
		.csr_readdata      (),                                                                                          // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) intel_generic_serial_flash_interface_avl_mem_agent (
		.clk                     (clk_main_clk_clk),                                                                          //             clk.clk
		.reset                   (intel_generic_serial_flash_interface_avl_csr_translator_reset_reset_bridge_in_reset_reset), //       clk_reset.reset
		.m0_address              (intel_generic_serial_flash_interface_avl_mem_agent_m0_address),                             //              m0.address
		.m0_burstcount           (intel_generic_serial_flash_interface_avl_mem_agent_m0_burstcount),                          //                .burstcount
		.m0_byteenable           (intel_generic_serial_flash_interface_avl_mem_agent_m0_byteenable),                          //                .byteenable
		.m0_debugaccess          (intel_generic_serial_flash_interface_avl_mem_agent_m0_debugaccess),                         //                .debugaccess
		.m0_lock                 (intel_generic_serial_flash_interface_avl_mem_agent_m0_lock),                                //                .lock
		.m0_readdata             (intel_generic_serial_flash_interface_avl_mem_agent_m0_readdata),                            //                .readdata
		.m0_readdatavalid        (intel_generic_serial_flash_interface_avl_mem_agent_m0_readdatavalid),                       //                .readdatavalid
		.m0_read                 (intel_generic_serial_flash_interface_avl_mem_agent_m0_read),                                //                .read
		.m0_waitrequest          (intel_generic_serial_flash_interface_avl_mem_agent_m0_waitrequest),                         //                .waitrequest
		.m0_writedata            (intel_generic_serial_flash_interface_avl_mem_agent_m0_writedata),                           //                .writedata
		.m0_write                (intel_generic_serial_flash_interface_avl_mem_agent_m0_write),                               //                .write
		.rp_endofpacket          (intel_generic_serial_flash_interface_avl_mem_agent_rp_endofpacket),                         //              rp.endofpacket
		.rp_ready                (intel_generic_serial_flash_interface_avl_mem_agent_rp_ready),                               //                .ready
		.rp_valid                (intel_generic_serial_flash_interface_avl_mem_agent_rp_valid),                               //                .valid
		.rp_data                 (intel_generic_serial_flash_interface_avl_mem_agent_rp_data),                                //                .data
		.rp_startofpacket        (intel_generic_serial_flash_interface_avl_mem_agent_rp_startofpacket),                       //                .startofpacket
		...
		.rf_sink_ready           (intel_generic_serial_flash_interface_avl_mem_agent_rsp_fifo_out_ready),                     //         rf_sink.ready
		.rf_sink_valid           (intel_generic_serial_flash_interface_avl_mem_agent_rsp_fifo_out_valid),                     //                .valid
		.rf_sink_startofpacket   (intel_generic_serial_flash_interface_avl_mem_agent_rsp_fifo_out_startofpacket),             //                .startofpacket
		.rf_sink_endofpacket     (intel_generic_serial_flash_interface_avl_mem_agent_rsp_fifo_out_endofpacket),               //                .endofpacket
		.rf_sink_data            (intel_generic_serial_flash_interface_avl_mem_agent_rsp_fifo_out_data),                      //                .data
		.rf_source_ready         (intel_generic_serial_flash_interface_avl_mem_agent_rf_source_ready),                        //       rf_source.ready
		.rf_source_valid         (intel_generic_serial_flash_interface_avl_mem_agent_rf_source_valid),                        //                .valid
		.rf_source_startofpacket (intel_generic_serial_flash_interface_avl_mem_agent_rf_source_startofpacket),                //                .startofpacket
		.rf_source_endofpacket   (intel_generic_serial_flash_interface_avl_mem_agent_rf_source_endofpacket),                  //                .endofpacket
		.rf_source_data          (intel_generic_serial_flash_interface_avl_mem_agent_rf_source_data),                         //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_002_out_0_ready),                                                         // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_002_out_0_valid),                                                         //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_002_out_0_data),                                                          //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_002_out_0_error),                                                         //                .error
		.rdata_fifo_src_ready    (intel_generic_serial_flash_interface_avl_mem_agent_rdata_fifo_src_ready),                   //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (intel_generic_serial_flash_interface_avl_mem_agent_rdata_fifo_src_valid),                   //                .valid
		.rdata_fifo_src_data     (intel_generic_serial_flash_interface_avl_mem_agent_rdata_fifo_src_data),                    //                .data
		.m0_response             (2'b00),                                                                                     //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                                                       //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) intel_generic_serial_flash_interface_avl_mem_agent_rsp_fifo (
		.clk               (clk_main_clk_clk),                                                                          //       clk.clk
		.reset             (intel_generic_serial_flash_interface_avl_csr_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (intel_generic_serial_flash_interface_avl_mem_agent_rf_source_data),                         //        in.data
		.in_valid          (intel_generic_serial_flash_interface_avl_mem_agent_rf_source_valid),                        //          .valid
		.in_ready          (intel_generic_serial_flash_interface_avl_mem_agent_rf_source_ready),                        //          .ready
		.in_startofpacket  (intel_generic_serial_flash_interface_avl_mem_agent_rf_source_startofpacket),                //          .startofpacket
		.in_endofpacket    (intel_generic_serial_flash_interface_avl_mem_agent_rf_source_endofpacket),                  //          .endofpacket
		.out_data          (intel_generic_serial_flash_interface_avl_mem_agent_rsp_fifo_out_data),                      //       out.data
		.out_valid         (intel_generic_serial_flash_interface_avl_mem_agent_rsp_fifo_out_valid),                     //          .valid
		.out_ready         (intel_generic_serial_flash_interface_avl_mem_agent_rsp_fifo_out_ready),                     //          .ready
		.out_startofpacket (intel_generic_serial_flash_interface_avl_mem_agent_rsp_fifo_out_startofpacket),             //          .startofpacket
		.out_endofpacket   (intel_generic_serial_flash_interface_avl_mem_agent_rsp_fifo_out_endofpacket),               //          .endofpacket
		.csr_address       (2'b00),                                                                                     // (terminated)
		.csr_read          (1'b0),                                                                                      // (terminated)
		.csr_write         (1'b0),                                                                                      // (terminated)
		.csr_readdata      (),                                                                                          // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) pio_lcd_control_s1_agent (
		.clk                     (clk_main_clk_clk),                                    //             clk.clk
		.reset                   (nios2_cpu_reset_reset_bridge_in_reset_reset),         //       clk_reset.reset
		.m0_address              (pio_lcd_control_s1_agent_m0_address),                 //              m0.address
		.m0_burstcount           (pio_lcd_control_s1_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (pio_lcd_control_s1_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (pio_lcd_control_s1_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (pio_lcd_control_s1_agent_m0_lock),                    //                .lock
		.m0_readdata             (pio_lcd_control_s1_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (pio_lcd_control_s1_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (pio_lcd_control_s1_agent_m0_read),                    //                .read
		.m0_waitrequest          (pio_lcd_control_s1_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (pio_lcd_control_s1_agent_m0_writedata),               //                .writedata
		.m0_write                (pio_lcd_control_s1_agent_m0_write),                   //                .write
		.rp_endofpacket          (pio_lcd_control_s1_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (pio_lcd_control_s1_agent_rp_ready),                   //                .ready
		.rp_valid                (pio_lcd_control_s1_agent_rp_valid),                   //                .valid
		.rp_data                 (pio_lcd_control_s1_agent_rp_data),                    //                .data
		.rp_startofpacket        (pio_lcd_control_s1_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (pio_lcd_control_s1_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (pio_lcd_control_s1_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (pio_lcd_control_s1_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (pio_lcd_control_s1_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (pio_lcd_control_s1_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (pio_lcd_control_s1_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (pio_lcd_control_s1_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (pio_lcd_control_s1_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (pio_lcd_control_s1_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (pio_lcd_control_s1_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_006_out_0_ready),                   // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_006_out_0_valid),                   //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_006_out_0_data),                    //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_006_out_0_error),                   //                .error
		.rdata_fifo_src_ready    (pio_lcd_control_s1_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (pio_lcd_control_s1_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (pio_lcd_control_s1_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                               //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                 //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) pio_lcd_control_s1_agent_rsp_fifo (
		.clk               (clk_main_clk_clk),                                    //       clk.clk
		.reset             (nios2_cpu_reset_reset_bridge_in_reset_reset),         // clk_reset.reset
		.in_data           (pio_lcd_control_s1_agent_rf_source_data),             //        in.data
		.in_valid          (pio_lcd_control_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (pio_lcd_control_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (pio_lcd_control_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (pio_lcd_control_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (pio_lcd_control_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (pio_lcd_control_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (pio_lcd_control_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (pio_lcd_control_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (pio_lcd_control_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                               // (terminated)
		.csr_read          (1'b0),                                                // (terminated)
		.csr_write         (1'b0),                                                // (terminated)
		.csr_readdata      (),                                                    // (terminated)
	...
	nios_core_mm_interconnect_0_router_002 router_003 (
		.sink_ready         (intel_generic_serial_flash_interface_avl_csr_agent_rp_ready),                               //      sink.ready
		.sink_valid         (intel_generic_serial_flash_interface_avl_csr_agent_rp_valid),                               //          .valid
		.sink_data          (intel_generic_serial_flash_interface_avl_csr_agent_rp_data),                                //          .data
		.sink_startofpacket (intel_generic_serial_flash_interface_avl_csr_agent_rp_startofpacket),                       //          .startofpacket
		.sink_endofpacket   (intel_generic_serial_flash_interface_avl_csr_agent_rp_endofpacket),                         //          .endofpacket
		.clk                (clk_main_clk_clk),                                                                          //       clk.clk
		.reset              (intel_generic_serial_flash_interface_avl_csr_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_core_mm_interconnect_0_router_004 router_004 (
		.sink_ready         (intel_generic_serial_flash_interface_avl_mem_agent_rp_ready),                               //      sink.ready
		.sink_valid         (intel_generic_serial_flash_interface_avl_mem_agent_rp_valid),                               //          .valid
		.sink_data          (intel_generic_serial_flash_interface_avl_mem_agent_rp_data),                                //          .data
		.sink_startofpacket (intel_generic_serial_flash_interface_avl_mem_agent_rp_startofpacket),                       //          .startofpacket
		.sink_endofpacket   (intel_generic_serial_flash_interface_avl_mem_agent_rp_endofpacket),                         //          .endofpacket
		.clk                (clk_main_clk_clk),                                                                          //       clk.clk
		.reset              (intel_generic_serial_flash_interface_avl_csr_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_core_mm_interconnect_0_router_004 router_007 (
	...
	nios_core_mm_interconnect_0_router_004 router_008 (
		.sink_ready         (pio_lcd_control_s1_agent_rp_ready),           //      sink.ready
		.sink_valid         (pio_lcd_control_s1_agent_rp_valid),           //          .valid
		.sink_data          (pio_lcd_control_s1_agent_rp_data),            //          .data
		.sink_startofpacket (pio_lcd_control_s1_agent_rp_startofpacket),   //          .startofpacket
		.sink_endofpacket   (pio_lcd_control_s1_agent_rp_endofpacket),     //          .endofpacket
		.clk                (clk_main_clk_clk),                            //       clk.clk
		.reset              (nios2_cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_core_mm_interconnect_0_cmd_mux_002 cmd_mux_002 (
		.clk                 (clk_main_clk_clk),                                                                          //       clk.clk
		.reset               (intel_generic_serial_flash_interface_avl_csr_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_core_mm_interconnect_0_cmd_mux_002 cmd_mux_005 (
		.clk                 (clk_main_clk_clk),                            //       clk.clk
		.reset               (nios2_cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_core_mm_interconnect_0_cmd_mux_002 cmd_mux_006 (
		.clk                 (clk_main_clk_clk),                            //       clk.clk
		.reset               (nios2_cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_core_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_main_clk_clk),                                                                          //       clk.clk
		.reset              (intel_generic_serial_flash_interface_avl_csr_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_core_mm_interconnect_0_rsp_demux_002 rsp_demux_005 (
		.clk                (clk_main_clk_clk),                            //       clk.clk
		.reset              (nios2_cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_core_mm_interconnect_0_rsp_demux_002 rsp_demux_006 (
		.clk                (clk_main_clk_clk),                            //       clk.clk
		.reset              (nios2_cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_core_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_main_clk_clk),                                                                          // in_clk_0.clk
		.in_rst_0_reset (intel_generic_serial_flash_interface_avl_csr_translator_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (intel_generic_serial_flash_interface_avl_csr_agent_rdata_fifo_src_data),                    //     in_0.data
		.in_0_valid     (intel_generic_serial_flash_interface_avl_csr_agent_rdata_fifo_src_valid),                   //         .valid
		.in_0_ready     (intel_generic_serial_flash_interface_avl_csr_agent_rdata_fifo_src_ready),                   //         .ready
	...
	nios_core_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_main_clk_clk),                                                                          // in_clk_0.clk
		.in_rst_0_reset (intel_generic_serial_flash_interface_avl_csr_translator_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (intel_generic_serial_flash_interface_avl_mem_agent_rdata_fifo_src_data),                    //     in_0.data
		.in_0_valid     (intel_generic_serial_flash_interface_avl_mem_agent_rdata_fifo_src_valid),                   //         .valid
		.in_0_ready     (intel_generic_serial_flash_interface_avl_mem_agent_rdata_fifo_src_ready),                   //         .ready
	...
	nios_core_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_main_clk_clk),                              // in_clk_0.clk
		.in_rst_0_reset (nios2_cpu_reset_reset_bridge_in_reset_reset),   // in_rst_0.reset
		.in_0_data      (pio_lcd_control_s1_agent_rdata_fifo_src_data),  //     in_0.data
		.in_0_valid     (pio_lcd_control_s1_agent_rdata_fifo_src_valid), //         .valid
		.in_0_ready     (pio_lcd_control_s1_agent_rdata_fifo_src_ready), //         .ready
