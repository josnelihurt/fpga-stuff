...
module mysystem_mm_interconnect_0 (
		...
		output wire [2:0]  oc_iic_0_av_address,                       //                         oc_iic_0_av.address
		output wire        oc_iic_0_av_write,                         //                                    .write
		output wire        oc_iic_0_av_read,                          //                                    .read
		input  wire [7:0]  oc_iic_0_av_readdata,                      //                                    .readdata
		output wire [7:0]  oc_iic_0_av_writedata,                     //                                    .writedata
		input  wire        oc_iic_0_av_waitrequest,                   //                                    .waitrequest
		output wire        oc_iic_0_av_chipselect,                    //                                    .chipselect
	...
	wire         cmd_mux_src_valid;                                                           // cmd_mux:src_valid -> onchip_s1_agent:cp_valid
	wire  [90:0] cmd_mux_src_data;                                                            // cmd_mux:src_data -> onchip_s1_agent:cp_data
	wire         cmd_mux_src_ready;                                                           // onchip_s1_agent:cp_ready -> cmd_mux:src_ready
	wire   [6:0] cmd_mux_src_channel;                                                         // cmd_mux:src_channel -> onchip_s1_agent:cp_channel
	wire         cmd_mux_src_startofpacket;                                                   // cmd_mux:src_startofpacket -> onchip_s1_agent:cp_startofpacket
	wire         cmd_mux_src_endofpacket;                                                     // cmd_mux:src_endofpacket -> onchip_s1_agent:cp_endofpacket
	wire   [7:0] oc_iic_0_av_agent_m0_readdata;                                               // oc_iic_0_av_translator:uav_readdata -> oc_iic_0_av_agent:m0_readdata
	wire         oc_iic_0_av_agent_m0_waitrequest;                                            // oc_iic_0_av_translator:uav_waitrequest -> oc_iic_0_av_agent:m0_waitrequest
	wire         oc_iic_0_av_agent_m0_debugaccess;                                            // oc_iic_0_av_agent:m0_debugaccess -> oc_iic_0_av_translator:uav_debugaccess
	wire  [14:0] oc_iic_0_av_agent_m0_address;                                                // oc_iic_0_av_agent:m0_address -> oc_iic_0_av_translator:uav_address
	wire   [0:0] oc_iic_0_av_agent_m0_byteenable;                                             // oc_iic_0_av_agent:m0_byteenable -> oc_iic_0_av_translator:uav_byteenable
	wire         oc_iic_0_av_agent_m0_read;                                                   // oc_iic_0_av_agent:m0_read -> oc_iic_0_av_translator:uav_read
	wire         oc_iic_0_av_agent_m0_readdatavalid;                                          // oc_iic_0_av_translator:uav_readdatavalid -> oc_iic_0_av_agent:m0_readdatavalid
	wire         oc_iic_0_av_agent_m0_lock;                                                   // oc_iic_0_av_agent:m0_lock -> oc_iic_0_av_translator:uav_lock
	wire   [7:0] oc_iic_0_av_agent_m0_writedata;                                              // oc_iic_0_av_agent:m0_writedata -> oc_iic_0_av_translator:uav_writedata
	wire         oc_iic_0_av_agent_m0_write;                                                  // oc_iic_0_av_agent:m0_write -> oc_iic_0_av_translator:uav_write
	wire   [0:0] oc_iic_0_av_agent_m0_burstcount;                                             // oc_iic_0_av_agent:m0_burstcount -> oc_iic_0_av_translator:uav_burstcount
	wire         oc_iic_0_av_agent_rf_source_valid;                                           // oc_iic_0_av_agent:rf_source_valid -> oc_iic_0_av_agent_rsp_fifo:in_valid
	wire  [64:0] oc_iic_0_av_agent_rf_source_data;                                            // oc_iic_0_av_agent:rf_source_data -> oc_iic_0_av_agent_rsp_fifo:in_data
	wire         oc_iic_0_av_agent_rf_source_ready;                                           // oc_iic_0_av_agent_rsp_fifo:in_ready -> oc_iic_0_av_agent:rf_source_ready
	wire         oc_iic_0_av_agent_rf_source_startofpacket;                                   // oc_iic_0_av_agent:rf_source_startofpacket -> oc_iic_0_av_agent_rsp_fifo:in_startofpacket
	wire         oc_iic_0_av_agent_rf_source_endofpacket;                                     // oc_iic_0_av_agent:rf_source_endofpacket -> oc_iic_0_av_agent_rsp_fifo:in_endofpacket
	wire         oc_iic_0_av_agent_rsp_fifo_out_valid;                                        // oc_iic_0_av_agent_rsp_fifo:out_valid -> oc_iic_0_av_agent:rf_sink_valid
	wire  [64:0] oc_iic_0_av_agent_rsp_fifo_out_data;                                         // oc_iic_0_av_agent_rsp_fifo:out_data -> oc_iic_0_av_agent:rf_sink_data
	wire         oc_iic_0_av_agent_rsp_fifo_out_ready;                                        // oc_iic_0_av_agent:rf_sink_ready -> oc_iic_0_av_agent_rsp_fifo:out_ready
	wire         oc_iic_0_av_agent_rsp_fifo_out_startofpacket;                                // oc_iic_0_av_agent_rsp_fifo:out_startofpacket -> oc_iic_0_av_agent:rf_sink_startofpacket
	wire         oc_iic_0_av_agent_rsp_fifo_out_endofpacket;                                  // oc_iic_0_av_agent_rsp_fifo:out_endofpacket -> oc_iic_0_av_agent:rf_sink_endofpacket
	...
	wire  [91:0] nios2_jtag_debug_module_agent_rf_source_data;                                // nios2_jtag_debug_module_agent:rf_source_data -> nios2_jtag_debug_module_agent_rsp_fifo:in_data
	...
	wire  [91:0] nios2_jtag_debug_module_agent_rsp_fifo_out_data;                             // nios2_jtag_debug_module_agent_rsp_fifo:out_data -> nios2_jtag_debug_module_agent:rf_sink_data
	...
	wire  [90:0] cmd_mux_003_src_data;                                                        // cmd_mux_003:src_data -> nios2_jtag_debug_module_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                       // nios2_jtag_debug_module_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [6:0] cmd_mux_003_src_channel;                                                     // cmd_mux_003:src_channel -> nios2_jtag_debug_module_agent:cp_channel
	...
	wire  [14:0] pio_key_s1_agent_m0_address;                                                 // pio_key_s1_agent:m0_address -> pio_key_s1_translator:uav_address
	...
	wire  [91:0] pio_key_s1_agent_rf_source_data;                                             // pio_key_s1_agent:rf_source_data -> pio_key_s1_agent_rsp_fifo:in_data
	...
	wire  [91:0] pio_key_s1_agent_rsp_fifo_out_data;                                          // pio_key_s1_agent_rsp_fifo:out_data -> pio_key_s1_agent:rf_sink_data
	...
	wire  [90:0] cmd_mux_005_src_data;                                                        // cmd_mux_005:src_data -> pio_key_s1_agent:cp_data
	...
	wire  [14:0] pio_reset_s1_agent_m0_address;                                               // pio_reset_s1_agent:m0_address -> pio_reset_s1_translator:uav_address
	...
	wire  [91:0] pio_reset_s1_agent_rf_source_data;                                           // pio_reset_s1_agent:rf_source_data -> pio_reset_s1_agent_rsp_fifo:in_data
	...
	wire  [91:0] pio_reset_s1_agent_rsp_fifo_out_data;                                        // pio_reset_s1_agent_rsp_fifo:out_data -> pio_reset_s1_agent:rf_sink_data
	...
	wire         cmd_mux_006_src_valid;                                                       // cmd_mux_006:src_valid -> pio_reset_s1_agent:cp_valid
	wire  [90:0] cmd_mux_006_src_data;                                                        // cmd_mux_006:src_data -> pio_reset_s1_agent:cp_data
	wire         cmd_mux_006_src_ready;                                                       // pio_reset_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire   [6:0] cmd_mux_006_src_channel;                                                     // cmd_mux_006:src_channel -> pio_reset_s1_agent:cp_channel
	wire         cmd_mux_006_src_startofpacket;                                               // cmd_mux_006:src_startofpacket -> pio_reset_s1_agent:cp_startofpacket
	wire         cmd_mux_006_src_endofpacket;                                                 // cmd_mux_006:src_endofpacket -> pio_reset_s1_agent:cp_endofpacket
	...
	wire         onchip_s1_agent_rp_valid;                                                    // onchip_s1_agent:rp_valid -> router_002:sink_valid
	wire  [90:0] onchip_s1_agent_rp_data;                                                     // onchip_s1_agent:rp_data -> router_002:sink_data
	wire         onchip_s1_agent_rp_ready;                                                    // router_002:sink_ready -> onchip_s1_agent:rp_ready
	wire         onchip_s1_agent_rp_startofpacket;                                            // onchip_s1_agent:rp_startofpacket -> router_002:sink_startofpacket
	wire         onchip_s1_agent_rp_endofpacket;                                              // onchip_s1_agent:rp_endofpacket -> router_002:sink_endofpacket
	...
	wire         oc_iic_0_av_agent_rp_valid;                                                  // oc_iic_0_av_agent:rp_valid -> router_003:sink_valid
	wire  [63:0] oc_iic_0_av_agent_rp_data;                                                   // oc_iic_0_av_agent:rp_data -> router_003:sink_data
	wire         oc_iic_0_av_agent_rp_ready;                                                  // router_003:sink_ready -> oc_iic_0_av_agent:rp_ready
	wire         oc_iic_0_av_agent_rp_startofpacket;                                          // oc_iic_0_av_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire         oc_iic_0_av_agent_rp_endofpacket;                                            // oc_iic_0_av_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire  [90:0] nios2_jtag_debug_module_agent_rp_data;                                       // nios2_jtag_debug_module_agent:rp_data -> router_005:sink_data
	...
	wire  [90:0] pio_key_s1_agent_rp_data;                                                    // pio_key_s1_agent:rp_data -> router_007:sink_data
	...
	wire         pio_reset_s1_agent_rp_valid;                                                 // pio_reset_s1_agent:rp_valid -> router_008:sink_valid
	wire  [90:0] pio_reset_s1_agent_rp_data;                                                  // pio_reset_s1_agent:rp_data -> router_008:sink_data
	wire         pio_reset_s1_agent_rp_ready;                                                 // router_008:sink_ready -> pio_reset_s1_agent:rp_ready
	wire         pio_reset_s1_agent_rp_startofpacket;                                         // pio_reset_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire         pio_reset_s1_agent_rp_endofpacket;                                           // pio_reset_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	...
	wire         oc_iic_0_av_burst_adapter_source0_valid;                                     // oc_iic_0_av_burst_adapter:source0_valid -> oc_iic_0_av_agent:cp_valid
	wire  [63:0] oc_iic_0_av_burst_adapter_source0_data;                                      // oc_iic_0_av_burst_adapter:source0_data -> oc_iic_0_av_agent:cp_data
	wire         oc_iic_0_av_burst_adapter_source0_ready;                                     // oc_iic_0_av_agent:cp_ready -> oc_iic_0_av_burst_adapter:source0_ready
	wire   [6:0] oc_iic_0_av_burst_adapter_source0_channel;                                   // oc_iic_0_av_burst_adapter:source0_channel -> oc_iic_0_av_agent:cp_channel
	wire         oc_iic_0_av_burst_adapter_source0_startofpacket;                             // oc_iic_0_av_burst_adapter:source0_startofpacket -> oc_iic_0_av_agent:cp_startofpacket
	wire         oc_iic_0_av_burst_adapter_source0_endofpacket;                               // oc_iic_0_av_burst_adapter:source0_endofpacket -> oc_iic_0_av_agent:cp_endofpacket
	...
	wire         router_003_src_valid;                                                        // router_003:src_valid -> oc_iic_0_av_rsp_width_adapter:in_valid
	wire  [63:0] router_003_src_data;                                                         // router_003:src_data -> oc_iic_0_av_rsp_width_adapter:in_data
	wire         router_003_src_ready;                                                        // oc_iic_0_av_rsp_width_adapter:in_ready -> router_003:src_ready
	wire   [6:0] router_003_src_channel;                                                      // router_003:src_channel -> oc_iic_0_av_rsp_width_adapter:in_channel
	wire         router_003_src_startofpacket;                                                // router_003:src_startofpacket -> oc_iic_0_av_rsp_width_adapter:in_startofpacket
	wire         router_003_src_endofpacket;                                                  // router_003:src_endofpacket -> oc_iic_0_av_rsp_width_adapter:in_endofpacket
	wire         oc_iic_0_av_rsp_width_adapter_src_valid;                                     // oc_iic_0_av_rsp_width_adapter:out_valid -> rsp_demux_001:sink_valid
	wire  [90:0] oc_iic_0_av_rsp_width_adapter_src_data;                                      // oc_iic_0_av_rsp_width_adapter:out_data -> rsp_demux_001:sink_data
	wire         oc_iic_0_av_rsp_width_adapter_src_ready;                                     // rsp_demux_001:sink_ready -> oc_iic_0_av_rsp_width_adapter:out_ready
	wire   [6:0] oc_iic_0_av_rsp_width_adapter_src_channel;                                   // oc_iic_0_av_rsp_width_adapter:out_channel -> rsp_demux_001:sink_channel
	wire         oc_iic_0_av_rsp_width_adapter_src_startofpacket;                             // oc_iic_0_av_rsp_width_adapter:out_startofpacket -> rsp_demux_001:sink_startofpacket
	wire         oc_iic_0_av_rsp_width_adapter_src_endofpacket;                               // oc_iic_0_av_rsp_width_adapter:out_endofpacket -> rsp_demux_001:sink_endofpacket
	wire         cmd_mux_001_src_valid;                                                       // cmd_mux_001:src_valid -> oc_iic_0_av_cmd_width_adapter:in_valid
	wire  [90:0] cmd_mux_001_src_data;                                                        // cmd_mux_001:src_data -> oc_iic_0_av_cmd_width_adapter:in_data
	wire         cmd_mux_001_src_ready;                                                       // oc_iic_0_av_cmd_width_adapter:in_ready -> cmd_mux_001:src_ready
	wire   [6:0] cmd_mux_001_src_channel;                                                     // cmd_mux_001:src_channel -> oc_iic_0_av_cmd_width_adapter:in_channel
	wire         cmd_mux_001_src_startofpacket;                                               // cmd_mux_001:src_startofpacket -> oc_iic_0_av_cmd_width_adapter:in_startofpacket
	wire         cmd_mux_001_src_endofpacket;                                                 // cmd_mux_001:src_endofpacket -> oc_iic_0_av_cmd_width_adapter:in_endofpacket
	wire         oc_iic_0_av_cmd_width_adapter_src_valid;                                     // oc_iic_0_av_cmd_width_adapter:out_valid -> oc_iic_0_av_burst_adapter:sink0_valid
	wire  [63:0] oc_iic_0_av_cmd_width_adapter_src_data;                                      // oc_iic_0_av_cmd_width_adapter:out_data -> oc_iic_0_av_burst_adapter:sink0_data
	wire         oc_iic_0_av_cmd_width_adapter_src_ready;                                     // oc_iic_0_av_burst_adapter:sink0_ready -> oc_iic_0_av_cmd_width_adapter:out_ready
	wire   [6:0] oc_iic_0_av_cmd_width_adapter_src_channel;                                   // oc_iic_0_av_cmd_width_adapter:out_channel -> oc_iic_0_av_burst_adapter:sink0_channel
	wire         oc_iic_0_av_cmd_width_adapter_src_startofpacket;                             // oc_iic_0_av_cmd_width_adapter:out_startofpacket -> oc_iic_0_av_burst_adapter:sink0_startofpacket
	wire         oc_iic_0_av_cmd_width_adapter_src_endofpacket;                               // oc_iic_0_av_cmd_width_adapter:out_endofpacket -> oc_iic_0_av_burst_adapter:sink0_endofpacket
	wire         onchip_s1_agent_rdata_fifo_src_valid;                                        // onchip_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter:in_0_valid
	wire  [33:0] onchip_s1_agent_rdata_fifo_src_data;                                         // onchip_s1_agent:rdata_fifo_src_data -> avalon_st_adapter:in_0_data
	wire         onchip_s1_agent_rdata_fifo_src_ready;                                        // avalon_st_adapter:in_0_ready -> onchip_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_out_0_valid;                                               // avalon_st_adapter:out_0_valid -> onchip_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_out_0_data;                                                // avalon_st_adapter:out_0_data -> onchip_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_out_0_ready;                                               // onchip_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter:out_0_ready
	wire   [0:0] avalon_st_adapter_out_0_error;                                               // avalon_st_adapter:out_0_error -> onchip_s1_agent:rdata_fifo_sink_error
	wire         oc_iic_0_av_agent_rdata_fifo_src_valid;                                      // oc_iic_0_av_agent:rdata_fifo_src_valid -> avalon_st_adapter_001:in_0_valid
	wire   [9:0] oc_iic_0_av_agent_rdata_fifo_src_data;                                       // oc_iic_0_av_agent:rdata_fifo_src_data -> avalon_st_adapter_001:in_0_data
	wire         oc_iic_0_av_agent_rdata_fifo_src_ready;                                      // avalon_st_adapter_001:in_0_ready -> oc_iic_0_av_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_001_out_0_valid;                                           // avalon_st_adapter_001:out_0_valid -> oc_iic_0_av_agent:rdata_fifo_sink_valid
	wire   [9:0] avalon_st_adapter_001_out_0_data;                                            // avalon_st_adapter_001:out_0_data -> oc_iic_0_av_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_001_out_0_ready;                                           // oc_iic_0_av_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire   [0:0] avalon_st_adapter_001_out_0_error;                                           // avalon_st_adapter_001:out_0_error -> oc_iic_0_av_agent:rdata_fifo_sink_error
	...
	wire         pio_reset_s1_agent_rdata_fifo_src_valid;                                     // pio_reset_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire  [33:0] pio_reset_s1_agent_rdata_fifo_src_data;                                      // pio_reset_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire         pio_reset_s1_agent_rdata_fifo_src_ready;                                     // avalon_st_adapter_006:in_0_ready -> pio_reset_s1_agent:rdata_fifo_src_ready
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (clk_0_clk_clk),                             //                      clk.clk
		.reset                  (nios2_reset_n_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (oc_iic_0_av_agent_m0_address),              // avalon_universal_slave_0.address
		.uav_burstcount         (oc_iic_0_av_agent_m0_burstcount),           //                         .burstcount
		.uav_read               (oc_iic_0_av_agent_m0_read),                 //                         .read
		.uav_write              (oc_iic_0_av_agent_m0_write),                //                         .write
		.uav_waitrequest        (oc_iic_0_av_agent_m0_waitrequest),          //                         .waitrequest
		.uav_readdatavalid      (oc_iic_0_av_agent_m0_readdatavalid),        //                         .readdatavalid
		.uav_byteenable         (oc_iic_0_av_agent_m0_byteenable),           //                         .byteenable
		.uav_readdata           (oc_iic_0_av_agent_m0_readdata),             //                         .readdata
		.uav_writedata          (oc_iic_0_av_agent_m0_writedata),            //                         .writedata
		.uav_lock               (oc_iic_0_av_agent_m0_lock),                 //                         .lock
		.uav_debugaccess        (oc_iic_0_av_agent_m0_debugaccess),          //                         .debugaccess
		.av_address             (oc_iic_0_av_address),                       //      avalon_anti_slave_0.address
		.av_write               (oc_iic_0_av_write),                         //                         .write
		.av_read                (oc_iic_0_av_read),                          //                         .read
		.av_readdata            (oc_iic_0_av_readdata),                      //                         .readdata
		.av_writedata           (oc_iic_0_av_writedata),                     //                         .writedata
		.av_waitrequest         (oc_iic_0_av_waitrequest),                   //                         .waitrequest
		.av_chipselect          (oc_iic_0_av_chipselect),                    //                         .chipselect
		.av_begintransfer       (),                                          //              (terminated)
		.av_beginbursttransfer  (),                                          //              (terminated)
		.av_burstcount          (),                                          //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                   //             clk.clk
		.reset                   (nios2_reset_n_reset_bridge_in_reset_reset),       //       clk_reset.reset
		.m0_address              (oc_iic_0_av_agent_m0_address),                    //              m0.address
		.m0_burstcount           (oc_iic_0_av_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (oc_iic_0_av_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (oc_iic_0_av_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (oc_iic_0_av_agent_m0_lock),                       //                .lock
		.m0_readdata             (oc_iic_0_av_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (oc_iic_0_av_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (oc_iic_0_av_agent_m0_read),                       //                .read
		.m0_waitrequest          (oc_iic_0_av_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (oc_iic_0_av_agent_m0_writedata),                  //                .writedata
		.m0_write                (oc_iic_0_av_agent_m0_write),                      //                .write
		.rp_endofpacket          (oc_iic_0_av_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (oc_iic_0_av_agent_rp_ready),                      //                .ready
		.rp_valid                (oc_iic_0_av_agent_rp_valid),                      //                .valid
		.rp_data                 (oc_iic_0_av_agent_rp_data),                       //                .data
		.rp_startofpacket        (oc_iic_0_av_agent_rp_startofpacket),              //                .startofpacket
		.cp_ready                (oc_iic_0_av_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (oc_iic_0_av_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (oc_iic_0_av_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (oc_iic_0_av_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (oc_iic_0_av_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (oc_iic_0_av_burst_adapter_source0_channel),       //                .channel
		.rf_sink_ready           (oc_iic_0_av_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (oc_iic_0_av_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (oc_iic_0_av_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (oc_iic_0_av_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (oc_iic_0_av_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (oc_iic_0_av_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (oc_iic_0_av_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (oc_iic_0_av_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (oc_iic_0_av_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (oc_iic_0_av_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_001_out_0_ready),               // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_001_out_0_valid),               //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_001_out_0_data),                //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_001_out_0_error),               //                .error
		.rdata_fifo_src_ready    (oc_iic_0_av_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (oc_iic_0_av_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (oc_iic_0_av_agent_rdata_fifo_src_data),           //                .data
		.m0_response             (2'b00),                                           //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                             //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) oc_iic_0_av_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                //       clk.clk
		.reset             (nios2_reset_n_reset_bridge_in_reset_reset),    // clk_reset.reset
		.in_data           (oc_iic_0_av_agent_rf_source_data),             //        in.data
		.in_valid          (oc_iic_0_av_agent_rf_source_valid),            //          .valid
		.in_ready          (oc_iic_0_av_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (oc_iic_0_av_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (oc_iic_0_av_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (oc_iic_0_av_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (oc_iic_0_av_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (oc_iic_0_av_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (oc_iic_0_av_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (oc_iic_0_av_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                        // (terminated)
		.csr_read          (1'b0),                                         // (terminated)
		.csr_write         (1'b0),                                         // (terminated)
		.csr_readdata      (),                                             // (terminated)
	...
	mysystem_mm_interconnect_0_router_003 router_003 (
		.sink_ready         (oc_iic_0_av_agent_rp_ready),                //      sink.ready
		.sink_valid         (oc_iic_0_av_agent_rp_valid),                //          .valid
		.sink_data          (oc_iic_0_av_agent_rp_data),                 //          .data
		.sink_startofpacket (oc_iic_0_av_agent_rp_startofpacket),        //          .startofpacket
		.sink_endofpacket   (oc_iic_0_av_agent_rp_endofpacket),          //          .endofpacket
		.clk                (clk_0_clk_clk),                             //       clk.clk
		.reset              (nios2_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	mysystem_mm_interconnect_0_router_002 router_005 (
	...
	) oc_iic_0_av_burst_adapter (
		.clk                   (clk_0_clk_clk),                                   //       cr0.clk
		.reset                 (nios2_reset_n_reset_bridge_in_reset_reset),       // cr0_reset.reset
		.sink0_valid           (oc_iic_0_av_cmd_width_adapter_src_valid),         //     sink0.valid
		.sink0_data            (oc_iic_0_av_cmd_width_adapter_src_data),          //          .data
		.sink0_channel         (oc_iic_0_av_cmd_width_adapter_src_channel),       //          .channel
		.sink0_startofpacket   (oc_iic_0_av_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.sink0_endofpacket     (oc_iic_0_av_cmd_width_adapter_src_endofpacket),   //          .endofpacket
		.sink0_ready           (oc_iic_0_av_cmd_width_adapter_src_ready),         //          .ready
		.source0_valid         (oc_iic_0_av_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (oc_iic_0_av_burst_adapter_source0_data),          //          .data
		.source0_channel       (oc_iic_0_av_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (oc_iic_0_av_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (oc_iic_0_av_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (oc_iic_0_av_burst_adapter_source0_ready)          //          .ready
	);
	...
	mysystem_mm_interconnect_0_cmd_mux_001 cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                             //       clk.clk
		.reset               (pio_led_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	mysystem_mm_interconnect_0_cmd_mux_001 cmd_mux_005 (
		.clk                 (clk_0_clk_clk),                             //       clk.clk
		.reset               (pio_led_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	mysystem_mm_interconnect_0_cmd_mux_001 cmd_mux_006 (
		.clk                 (clk_0_clk_clk),                             //       clk.clk
		.reset               (pio_led_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	mysystem_mm_interconnect_0_cmd_demux_001 rsp_demux (
		.clk                (clk_0_clk_clk),                             //       clk.clk
		.reset              (nios2_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	mysystem_mm_interconnect_0_rsp_demux_001 rsp_demux_001 (
		.clk                (clk_0_clk_clk),                                   //       clk.clk
		.reset              (nios2_reset_n_reset_bridge_in_reset_reset),       // clk_reset.reset
		.sink_ready         (oc_iic_0_av_rsp_width_adapter_src_ready),         //      sink.ready
		.sink_channel       (oc_iic_0_av_rsp_width_adapter_src_channel),       //          .channel
		.sink_data          (oc_iic_0_av_rsp_width_adapter_src_data),          //          .data
		.sink_startofpacket (oc_iic_0_av_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.sink_endofpacket   (oc_iic_0_av_rsp_width_adapter_src_endofpacket),   //          .endofpacket
		.sink_valid         (oc_iic_0_av_rsp_width_adapter_src_valid),         //          .valid
	...
	mysystem_mm_interconnect_0_cmd_demux_001 rsp_demux_003 (
		.clk                (clk_0_clk_clk),                             //       clk.clk
		.reset              (nios2_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	mysystem_mm_interconnect_0_rsp_demux_001 rsp_demux_004 (
		.clk                (clk_0_clk_clk),                             //       clk.clk
		.reset              (pio_led_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	mysystem_mm_interconnect_0_rsp_demux_001 rsp_demux_005 (
		.clk                (clk_0_clk_clk),                             //       clk.clk
		.reset              (pio_led_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	mysystem_mm_interconnect_0_rsp_demux_001 rsp_demux_006 (
		.clk                (clk_0_clk_clk),                             //       clk.clk
		.reset              (pio_led_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_merlin_width_adapter #(
		...
		.out_endofpacket      (oc_iic_0_av_rsp_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (oc_iic_0_av_rsp_width_adapter_src_data),          //          .data
		.out_channel          (oc_iic_0_av_rsp_width_adapter_src_channel),       //          .channel
		.out_valid            (oc_iic_0_av_rsp_width_adapter_src_valid),         //          .valid
		.out_ready            (oc_iic_0_av_rsp_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (oc_iic_0_av_rsp_width_adapter_src_startofpacket), //          .startofpacket
	...
	altera_merlin_width_adapter #(
		...
		.out_endofpacket      (oc_iic_0_av_cmd_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (oc_iic_0_av_cmd_width_adapter_src_data),          //          .data
		.out_channel          (oc_iic_0_av_cmd_width_adapter_src_channel),       //          .channel
		.out_valid            (oc_iic_0_av_cmd_width_adapter_src_valid),         //          .valid
		.out_ready            (oc_iic_0_av_cmd_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (oc_iic_0_av_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                           // (terminated)
	);
	...
	mysystem_mm_interconnect_0_avalon_st_adapter_001 #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                             // in_clk_0.clk
		.in_rst_0_reset (nios2_reset_n_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (oc_iic_0_av_agent_rdata_fifo_src_data),     //     in_0.data
		.in_0_valid     (oc_iic_0_av_agent_rdata_fifo_src_valid),    //         .valid
		.in_0_ready     (oc_iic_0_av_agent_rdata_fifo_src_ready),    //         .ready
	...
	mysystem_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                             // in_clk_0.clk
		.in_rst_0_reset (pio_led_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (pio_reset_s1_agent_rdata_fifo_src_data),    //     in_0.data
		.in_0_valid     (pio_reset_s1_agent_rdata_fifo_src_valid),   //         .valid
		.in_0_ready     (pio_reset_s1_agent_rdata_fifo_src_ready),   //         .ready
